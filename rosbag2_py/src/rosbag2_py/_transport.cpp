...
PYBIND11_MODULE(_transport, m) {
  ...
  .def_readwrite("latched_all_transient_local", &RecordOptions::latched_all_transient_local)
  .def_readwrite("latched_topics", &RecordOptions::latched_topics)
  .def_readwrite("latched_regex", &RecordOptions::latched_regex)
  .def_readwrite("latched_exclude", &RecordOptions::latched_exclude)
